...
![](C:\Users\Fiona\Desktop\SDM_Course\maxent_pic_lab4.png)
...
![](C:\Users\Fiona\Desktop\SDM_Course\maxent_pic_lab4b.png)
...
```{r, eval=FALSE}
capg<-read.csv("Your_Species_Occurence_Data_From_Lab_1.csv")
...
```{r}
names(env50crop) <-c("bio1","bio2","bio3","bio4","bio5","bio6","bio7","bio8",
...
writeRaster(stack(env50crop[[c(1,4,11,12,14,19)]]), names(env50crop[[c(1,4,11,12,14,19)]]), 
            bylayer=TRUE, format='ascii', overwrite=T)
...
![](C:\Users\Fiona\Desktop\SDM_Course\future.png)
